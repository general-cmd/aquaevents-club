...
## User-Reported Issues - Swimming Caps & Blog

- [x] Fix swimming caps inquiry notification to include all form details (name, email, phone, organization, quantity, colors, message)
- [x] Add swimming events 2026 blog post to blog listing page (insert into database)
- [x] Add latex caps pricing table to gorros-natacion page (€2.10-€1.00 for 50-15K units)
