          ...
          "review": [
            {
              ...
              "reviewBody": "Comunicación excelente por teléfono y email. Gorros de silicona con impresión a 2 colores, aspecto y tacto geniales."
            },
            {
              "@type": "Review",
              "reviewRating": {
            ...
            },
            {
              ...
              "reviewBody": "Pedimos 250 gorros y fueron brillantes en todo momento. La calidad es excelente."
            }
          ],
          "category": "Equipamiento Deportivo > Natación"
        };

        // FAQPage schema removed - now handled by client-side component for multilingual support
