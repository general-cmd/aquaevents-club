  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        {/* AQUA20 Discount Banner */}
        <div className="mt-8 bg-gradient-to-r from-green-600 to-emerald-500 text-white p-6 rounded-lg shadow-xl max-w-3xl mx-auto">
          <div className="text-center">
            <h3 className="text-2xl font-bold mb-2">🎉 ¡Descuento Especial para Eventos AquaEvents.club!</h3>
            <p className="text-lg mb-3">Usa el código <span className="bg-white text-green-600 px-4 py-1 rounded-lg font-bold text-xl">AQUA20</span> y obtén</p>
            <p className="text-3xl font-bold mb-2">20% de Descuento</p>
            <p className="text-green-100">en todos los pedidos de gorros personalizados</p>
          </div>
        </div>

        {/* Latex Caps Pricing Table */}
        <div className="mt-16">
          <h3 className="text-2xl font-bold text-center mb-4">Gorros de Látex - Opción Económica</h3>
          <p className="text-center text-gray-600 mb-8 max-w-2xl mx-auto">
            Para eventos con presupuesto ajustado, ofrecemos gorros de látex personalizados con excelente relación calidad-precio.
            Ideales para travesías populares y eventos de participación masiva.
          </p>
            ...
            <table className="w-full border-collapse bg-white shadow-lg rounded-lg overflow-hidden">
              ...
              <tbody>
                <tr className="border-b hover:bg-gray-50">
                  ...
                  <td className="p-4">62% más económico</td>
                  <td className="p-4 text-green-600 font-semibold">GRATIS</td>
                </tr>
                <tr className="border-b hover:bg-gray-50 bg-green-50">
                  <td className="p-4 font-semibold">100 unidades</td>
                  <td className="p-4 text-green-600 font-semibold">1,90€</td>
                  <td className="p-4">57% más económico</td>
                  <td className="p-4 text-green-600 font-semibold">GRATIS</td>
                </tr>
                <tr className="border-b hover:bg-gray-50">
                  <td className="p-4 font-semibold">500 unidades</td>
                  <td className="p-4 text-green-600 font-semibold">1,50€</td>
                  <td className="p-4">50% más económico</td>
                  <td className="p-4 text-green-600 font-semibold">GRATIS</td>
                </tr>
                <tr className="border-b hover:bg-gray-50 bg-green-50">
                  <td className="p-4 font-semibold">1.000 unidades</td>
                  <td className="p-4 text-green-600 font-semibold">1,20€</td>
                  <td className="p-4">52% más económico</td>
                  <td className="p-4 text-green-600 font-semibold">GRATIS</td>
                </tr>
                <tr className="border-b hover:bg-gray-50">
                  <td className="p-4 font-semibold">5.000 unidades</td>
                  <td className="p-4 text-green-600 font-semibold">1,10€</td>
                  <td className="p-4">Máximo ahorro</td>
                  <td className="p-4 text-green-600 font-semibold">GRATIS</td>
                </tr>
                <tr className="border-b hover:bg-gray-50 bg-green-50">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600 mb-4">
              * Gorros de látex: Menor durabilidad que silicona pero excelente para eventos de un solo uso | Impresión a 1-2 colores | Envío gratuito a península
            </p>
          </div>
        </div>
