...
export function getEventSpecificProducts(eventType: EventType, count: number = 3): Product[] {
  const productDatabase: Record<EventType, Product[]> = {
    pool: [
      {
        ...
        name: 'Speedo Biofuse 2.0 Swim Goggles',
      ...
      },
      {
        ...
        name: 'Arena Cobra Ultra Swipe Racing Goggles',
    ...
    open_water: [
      {
        ...
        name: 'Zone3 Swim Safety Buoy / Dry Bag (28L)',
      ...
      },
      {
        ...
        name: 'Aqua Sphere Kayenne Swim Goggles',
      ...
      },
      {
        ...
        name: 'BodyGlide Anti-Chafe Balm (Travel Size)',
    ...
    training: [
      {
        id: 'speedo-kickboard',
        name: 'Speedo Swimming Kickboard',
      ...
      },
      {
        ...
        name: 'Arena Pullkick Pro (Swim Training)',
      ...
      },
      {
        ...
        name: 'Speedo Tech Paddle (Training Tool)',
    ...
    triathlon: [
      ...
      },
      {
        ...
        name: 'Arena Powerfin Pro II Training Fins',
